...
public class LookupTable{
	...
	public static void main(String[] args){
	 try{
			/*LookupTable loot= new LookupTable();
	 		Nonterminal ntS= new Nonterminal('S');
			Nonterminal ntA1= new Nonterminal('A');
			Nonterminal ntA2= new Nonterminal('B');
	 		Terminal tA= new Terminal("a");
			Terminal tB= new Terminal("b");
	 		ProductionQueue pqP1a= new ProductionQueue("S->A1A2A1A3 A2->b A3->A4");
			ProductionQueue pqP1b= new ProductionQueue("S->bA1A2A1A3 A2->b A3->A4");
			ProductionQueue pqP2= new ProductionQueue("A1->aA2 A1->aA2 A4->A5");
			ProductionQueue pqP3= new ProductionQueue("A2->a A2->a A5->b");
			loot.addRow(ntS, tA, pqP1a);
			loot.addRow(ntA1, tA, pqP2);
			loot.addRow(ntA2, tA, pqP3);
