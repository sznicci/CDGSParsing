...
public class Parsing {
	...
	public String config(String x) {
		return "input: " + input + " mainStack: " + mainStack + " step: " + step + " StacksForN: " + stacksForN
				+ " pQueuesLeft: " + pQueuesLeft;
	}
	...
	public void parsing() {
		/*
		 * the constructor does it... step= 0; mainStack.push('S');
